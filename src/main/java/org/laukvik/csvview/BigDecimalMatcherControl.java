...
public class BigDecimalMatcherControl extends ColumnMatcherControl {
    ...
    private final org.laukvik.csvview.Main main;

    public BigDecimalMatcherControl(final BigDecimalColumn column, final org.laukvik.csvview.Main main) {
        super(column);
        this.main = main;
        ...
        rangeView = new org.laukvik.csvview.FrequencyDistributionTableView();
    ...
    public void loadCSV(final CSV csv) {
        ...
        if (rangedDistribution.getNullCount() > 0) {
            rangeView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
