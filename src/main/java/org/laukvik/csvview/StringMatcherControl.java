 ...
 *
 */
public class StringMatcherControl extends org.laukvik.csvview.ColumnMatcherControl {

    private final org.laukvik.csvview.FrequencyDistributionTableView uniqueView;
    private final org.laukvik.csvview.FrequencyDistributionTableView firstLetterView;
    private final org.laukvik.csvview.FrequencyDistributionTableView lengthView;
    private final org.laukvik.csvview.FrequencyDistributionTableView prefixView;
    private final org.laukvik.csvview.FrequencyDistributionTableView postfixView;
    private final org.laukvik.csvview.FrequencyDistributionTableView wordsView;
    ...
    public StringMatcherControl(final StringColumn column, final Main main) {
        ...
        this.main = main;
        uniqueView = new org.laukvik.csvview.FrequencyDistributionTableView();
        Tab uniqueTab = new Tab("Values");
        uniqueTab.setContent(uniqueView);
        firstLetterView = new org.laukvik.csvview.FrequencyDistributionTableView();
        Tab firstLetterTab = new Tab("Letter");
        firstLetterTab.setContent(firstLetterView);
        lengthView = new org.laukvik.csvview.FrequencyDistributionTableView();
        Tab lengthTab = new Tab("Length");
        lengthTab.setContent(lengthView);
        prefixView = new org.laukvik.csvview.FrequencyDistributionTableView();
        Tab prefixTab = new Tab("Prefix");
        prefixTab.setContent(prefixView);
        postfixView = new org.laukvik.csvview.FrequencyDistributionTableView();
        Tab postfixTab = new Tab("Postfix");
        postfixTab.setContent(postfixView);
        wordsView = new org.laukvik.csvview.FrequencyDistributionTableView();
...
//    }
    ...
    public void loadCSV(final CSV csv) {
        ...
        if (uniqueDistribution.getNullCount() > 0) {
            uniqueView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
        ...
        if (firstLetterDistribution.getNullCount() > 0) {
            firstLetterView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
        ...
        if (lengthDistribution.getNullCount() > 0) {
            lengthView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
        ...
        if (prefixDistribution.getNullCount() > 0) {
            prefixView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
        ...
        if (postfixDistribution.getNullCount() > 0) {
            postfixView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
        ...
        if (wordsDistribution.getNullCount() > 0) {
            wordsView.getItems().add(new org.laukvik.csvview.ObservableFrequencyDistribution(false,
